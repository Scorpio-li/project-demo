        ...
        sidebar: {
            ...
            '/outils/': [{
                ...
                children: [
                    ...
                    '/outils/methods/string', // js字符串处理
                    '/outils/methods/number', // js数字处理
                    '/outils/methods/dataprocess' // js常用数据处理
                ]
            }, {
                title: '算法总结',
                children: [
